...
export function BubbleOverlay({ getState }: BubbleOverlayProps) {
  ...
  return (
    <div ref={rootRef} className="bubble-overlay bubble-overlay--elegant" aria-hidden="true">
      <svg className="bubble-overlay__svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet">
        <defs>
          <radialGradient id="bubble-glint-grad-0820" cx="42%" cy="40%" r="58%">
          ...
          <filter id="bubble-glint-blur-0820" x="-80%" y="-80%" width="260%" height="260%">
            <feGaussianBlur in="SourceGraphic" stdDeviation="0.55" />
          </filter>
          <filter id="bubble-dust-blur-0820" x="-100%" y="-100%" width="300%" height="300%">
        ...
        <g className="bubble-overlay__glint-orbit">
          <ellipse
            ...
            rx="0.85"
            ry="2.65"
            fill="url(#bubble-glint-grad-0820)"
            filter="url(#bubble-glint-blur-0820)"
          />
          <g className="bubble-overlay__dust" filter="url(#bubble-dust-blur-0820)">
