          ...
          {[
            ...
            listStats
              ? [
                  ...
                  `pinchActive: ${listStats.pinchActive}  pinchDistance: ${listStats.pinchDistance.toFixed(1)}  pinchDelta: ${listStats.pinchDelta.toFixed(1)}  pinchDollyScale: ${listStats.pinchDollyScale}`,
          ...
          {JSON.stringify(
            {
              ...
              list: listStats
                ? {
                    ...
                    twoFingerDollyMaxDeltaPx: listStats.twoFingerDollyMaxDeltaPx,
                    twoFingerDollyScale: listStats.twoFingerDollyScale,
                    pinchActive: listStats.pinchActive,
                    pinchDistance: Number(listStats.pinchDistance.toFixed(1)),
                    ...
                    tapSuppressedByTwoFinger: listStats.tapSuppressedByTwoFinger,
